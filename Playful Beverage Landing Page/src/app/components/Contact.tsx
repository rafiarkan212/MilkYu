...
import logoImg from 'figma:asset/88a4a1c6d0abbe060992fd1fbc4b98fbf3bb9eb8.png';
  ...
  return (
    <section id="contact" className="py-24 px-6 md:px-12 bg-amber-950 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center flex flex-col items-center">
        ...
        >
          Jadilah yang pertama tahu saat minuman lezat kami rilis. Jangan sampai ketinggalan!
        </motion.p>
      ...
      <div className="absolute bottom-4 left-0 right-0 text-center">
        <p className="text-amber-200/40 text-sm font-medium">© {new Date().getFullYear()} Stickymilk. Hak Cipta Dilindungi.</p>
      </div>
    </section>
  );
}
